...
GRANT ALL ON TABLE "public"."ping" TO "anon";
GRANT ALL ON TABLE "public"."ping" TO "authenticated";
GRANT ALL ON TABLE "public"."ping" TO "service_role";



GRANT ALL ON SEQUENCE "public"."ping_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."ping_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."ping_id_seq" TO "service_role";
